...
2. Write a Constructor for Initializing Data Attributes
    ...
    File: data_ctrl.svh
    Task: Implement a constructor within the DataCtrl class. This constructor should initialize the class's data attributes. If no values are provided during object creation, default values should be set to 0 for each attribute.
